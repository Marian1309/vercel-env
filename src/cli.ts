...
const showHelp = () => {
  ...
  console.log("");
  console.log("Usage:");
  console.log("  npx @pidchashyi/vercel-env-sync --sync     # Sync environments (interactive)");
  console.log("  npx @pidchashyi/vercel-env-sync --delete   # Delete environment variables (interactive)");
  console.log("");
  ...
  console.log("  npx @pidchashyi/vercel-env-sync --sync");
  console.log("  npx @pidchashyi/vercel-env-sync --sync --dev --auto");
  console.log("  npx @pidchashyi/vercel-env-sync --sync --prod --interactive");
  console.log("  npx @pidchashyi/vercel-env-sync --delete");
  console.log("");
  console.log("Library Usage:");
  console.log("  import { syncEnvs, deleteEnvs } from '@pidchashyi/vercel-env-sync';");
